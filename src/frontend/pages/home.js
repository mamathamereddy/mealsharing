function homeRouter(req, router) {
  document.body.innerHTML = `<header class="container"> 
  ...
  <div class="card text-center" style="background-image: url('https://media.nomadicmatt.com/2019/sharingeconomy2019c.jpg'); background-size: cover;background-repeat: no-repeat;
  height:500px; width:100%;background-position: center;object-fit: cover; 
  position: relative;">
  <div class="card-body">
 ...
 <a href="#root" class="btn btn-success" >Find a meal</a>
